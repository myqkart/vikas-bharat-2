...
import { getRelatedBlogs, type BlogPost } from "@/lib/blogs";
...
export default function BlogArticlePage({ post }: { post: BlogPost }) {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-paper via-[#FFF8EE] to-[#EAF1FA] px-5 pt-28 pb-16 sm:px-8 lg:pt-36 lg:pb-20">
        ...
        >
          ...
          <motion.p
            ...
            className="mt-8 text-xs font-bold uppercase tracking-[0.18em] text-marigold-dark"
          >
            {post.category}
          </motion.p>
          <TextReveal
            ...
            text={post.title}
            onMount
            className="mt-3 font-display text-[2.1rem] font-semibold leading-[1.12] tracking-tight text-ink sm:text-5xl"
          />
          <motion.p
            variants={dramaticFadeUp}
          ...
          <motion.p
            variants={dramaticFadeUp}
            className="mt-4 text-sm font-semibold text-slate"
          >
      ...
      <section className="bg-[#FEFCF7] px-5 pb-20 sm:px-8 lg:pb-28">
        <div className="mx-auto max-w-[820px]">
          ...
          <div className="mt-12 space-y-10">
            {post.sections.map((section) => (
              <article key={section.heading}>
                ...
                <p className="mt-3 text-[16px] leading-[1.75] text-slate">{section.body}</p>
              </article>
            ))}
          </div>
          ...
          <div className="mt-14 flex flex-col gap-3 rounded-[24px] border border-border/70 bg-white p-6 shadow-card sm:flex-row sm:items-center sm:justify-between sm:p-8">
            <div>
              <p className="font-display text-2xl font-semibold text-ink">Ready for the next step?</p>
        ...
        <div className="mx-auto mt-20 max-w-[1200px]">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-slate">Keep reading</p>
          <h2 className="mt-2 font-display text-3xl font-semibold text-ink">Related guides</h2>
          <ul
