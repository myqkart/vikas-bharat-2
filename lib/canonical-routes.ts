export const SCHEME_CANONICAL_ALIASES: Record<string, string> = {
  "startup-india-seed-debt": "seed-fund",
  "horizon-fund-scheme": "horizon-fund",
  "venture-tech-funding": "venture-tech",
};

export const SCHEME_TO_SERVICE_PATHS: Record<string, string> = {
